...
export default function ProjectGallery({ onOpen }) {
  return <section id="photo-gallery" className="py-12 md:py-16">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mb-8"><h2 className="mb-4">More photos from our jobs</h2><p className="text-slate-600">Washrooms, timber floors, shop interiors and work during café fit-outs. Each photo is labelled so you can see whether it was taken before or after cleaning. Select any photo for the full view.</p></div>
