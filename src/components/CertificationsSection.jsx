...
import { ShieldCheck, Award, FileCheck, CalendarDays } from 'lucide-react';
...
const CertificationsSection = () => {
  const certs = [
    ...
    { icon: CalendarDays, title: 'Flexible Scheduling', desc: 'One-off & Recurring Visits' },
  ];
    ...
    <section className="py-16 bg-white border-y border-slate-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          <h2 className="text-2xl font-bold">Cleaning Standards & Service Options</h2>
        </div>
