    ...
    <section className="py-24 bg-[#203f3a] text-white text-center">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-lg text-slate-300 mb-10 leading-relaxed max-w-2xl mx-auto">
          Tell us your suburb, what needs cleaning and when you need it done. We’ll discuss the job and provide a quote.
        </p>
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <Button asChild size="lg" className="h-14 px-10 text-base font-semibold bg-secondary text-secondary-foreground hover:bg-secondary/90">
            <Link to={service ? '/contact?service=' + service.value : '/contact'}>Get a quote</Link>
          </Button>
