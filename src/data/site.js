...
export const pageCatalog = {
  ...
  '/services/window-cleaning': { title: 'Commercial Window Cleaning Adelaide | MisterClean', description: 'One-off and recurring window cleaning in Adelaide. Internal and external glass, shopfronts and hard-to-reach windows assessed before quoting.', name: 'Window Cleaning', image: '/images/window-cleaning.jpg' },
