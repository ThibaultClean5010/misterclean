...
export const pageCatalog = {
  ...
  '/projects': { title: 'Cleaning Projects Adelaide | Before & After | MisterClean', description: 'View original MisterClean project photos: a café kitchen floor before and after cleaning during fit-out, plus a post-construction retail project in Hindmarsh.', name: 'Our Cleaning Projects', image: '/images/hindmarsh-shopfront-interior.jpg' },
