    ...
    <section className="py-14 md:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          <h2>What we do</h2>
          <p className="text-lg text-muted-foreground">MisterClean cleans offices, shops and other business premises in Adelaide. Our services include regular cleaning, windows, deep cleans and cleaning after building work.</p>
          <p className="text-lg text-muted-foreground">Some jobs need a regular visit. Others need a one-off clean before opening or after renovations. Tell us which areas need cleaning, how often and when we can get access.</p>
          ...
          <p className="text-lg text-muted-foreground">For windows at height or areas with difficult access, we’ll check what’s possible before booking.</p>
