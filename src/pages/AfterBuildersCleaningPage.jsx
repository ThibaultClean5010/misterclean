...
export default function AfterBuildersCleaningPage() {
  ...
  return <>
    ...
    <section className="py-14 md:py-20"><div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mb-10"><h2 className="mb-5">From building work to a cleaner premises</h2><p className="text-lg text-slate-600 mb-4">Renovation and fit-out work can leave dust across floors, glazing and newly installed surfaces. We assess what needs attention and agree a cleaning scope around the condition of your Adelaide premises.</p><p className="text-slate-600">Tell us which trades are still working, which rooms are ready and when you need access. A staged clean may suit an ongoing fit-out; a final clean is planned around your handover. Our <Link to="/blog/after-builders-cleaning-before-handover" className="text-brand-ink underline">handover cleaning guide</Link> explains the areas and timing to consider.</p></div>
    ...
    <section className="py-14 md:py-20"><div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8"><h2 className="mb-6">After-builders cleaning questions</h2>
      ...
      <p className="mt-7 text-slate-600">After handover, explore <Link to="/services/commercial-cleaning" className="text-brand-ink underline">commercial cleaning</Link> or <Link to="/services/window-cleaning" className="text-brand-ink underline">window cleaning</Link>. For a broader reset of occupied premises, see <Link to="/services/commercial-deep-cleaning" className="text-brand-ink underline">commercial deep cleaning</Link>.</p>
    </div></section>
