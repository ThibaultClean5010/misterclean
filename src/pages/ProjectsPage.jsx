    ...
    <section id="cafe-fitout" className="py-14 md:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-8">
          ...
          <div><h3 className="text-lg mb-2">Planning a similar clean</h3><p className="text-slate-600">Agree which areas are ready, when trades will finish and how to protect the cleaned surfaces before handover. Our <Link to="/blog/after-builders-cleaning-before-handover" className="text-primary underline">after-builders cleaning guide</Link> covers the preparation.</p></div>
        </div>
