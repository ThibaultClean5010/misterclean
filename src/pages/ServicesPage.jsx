      ...
      <Reveal className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div>
            ...
            {offer.value === 'window-cleaning' && <p className="text-muted-foreground mb-6">Choose a one-off clean or a recurring schedule. Our <Link to="/blog/how-often-clean-commercial-windows-adelaide" className="text-primary underline">guide to window-cleaning frequency</Link> explains what affects the timing. For hard-to-reach windows, we assess height and access before confirming the work.</p>}
